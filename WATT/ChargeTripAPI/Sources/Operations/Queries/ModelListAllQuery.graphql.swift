...
public class ModelListAllQuery: GraphQLQuery {
  ...
  public var __variables: Variables? { ["brandName": brandName] }
  ...
  public struct Data: ChargeTripAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("carList", [CarList?]?.self, arguments: ["search": .variable("brandName")]),
    ] }
